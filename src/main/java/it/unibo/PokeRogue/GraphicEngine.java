 ...
 * Extends the {@link Singleton} interface to ensure that there is only one instance
 * of the graphic engine in the system.
 * 
 * The graphic engine is responsible for rendering and displaying the visual elements
 * of the game. It uses a collection of graphic elements to draw the current scene.
 */
public interface GraphicEngine extends Singleton {
     ...
     */
    void drawScene(Map<Integer, String> allGraphicElement);
}
