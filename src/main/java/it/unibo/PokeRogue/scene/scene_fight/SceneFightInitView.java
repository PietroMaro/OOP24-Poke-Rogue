...
public class SceneFightInitView {
        ...
        protected void initGraphicElements(final int currentSelectedButton) throws IOException {
                ...
                // box
                this.currentSceneGraphicElements.put(SceneFightGraphicEnum.MY_POKEMON_STATS_BOX.value(),
                                new BoxElementImpl(FIRST_PANEL, Color.GRAY, Color.WHITE, 2, 0.69, 0.58, 0.31, 0.1));
                this.currentSceneGraphicElements.put(SceneFightGraphicEnum.ENEMY_POKEMON_STATS_BOX.value(),
                ...
                this.currentSceneGraphicElements.put(SceneFightGraphicEnum.BACKGROUND.value(),
                                new BackgroundElementImpl(FIRST_PANEL,
                                                UtilitiesForScenes.getPathString("images", "bgBar.png")));
        ...
        private void initTextElements() {
                this.currentSceneGraphicElements.put(SceneFightGraphicEnum.BALL_BUTTON_TEXT.value(),
                                new TextElementImpl(FIRST_PANEL, "BALL", Color.WHITE, 0.06, 0.77, 0.80));
                this.currentSceneGraphicElements.put(SceneFightGraphicEnum.FIGHT_BUTTON_TEXT.value(),
                                new TextElementImpl(FIRST_PANEL, "FIGHT", Color.WHITE, 0.06, 0.55, 0.80));
                this.currentSceneGraphicElements.put(SceneFightGraphicEnum.RUN_BUTTON_TEXT.value(),
                ...
                this.currentSceneGraphicElements.put(SceneFightGraphicEnum.DETAILS_CONTAINER_TEXT.value(),
                                new TextElementImpl(FIRST_PANEL,
                                                ...
                                                Color.WHITE,
                                                0.06, 0.05, 0.865));
                this.currentSceneGraphicElements.put(SceneFightGraphicEnum.MY_POKEMON_NAME_TEXT.value(),
                                new TextElementImpl(FIRST_PANEL,
                                                SceneFightUtilities.getPokemonNameAt(playerTrainerInstance,
                                                                FIRST_POSITION),
                                                Color.WHITE,
                                                0.04, 0.69, 0.64));
                this.currentSceneGraphicElements.put(SceneFightGraphicEnum.ENEMY_POKEMON_NAME_TEXT.value(),
                                new TextElementImpl(FIRST_PANEL,
                                                ...
                                                0.04, 0, 0.06));
                // Lv POKEMON
                this.currentSceneGraphicElements.put(SceneFightGraphicEnum.MY_POKEMON_LEVEL_TEXT.value(),
                                new TextElementImpl(FIRST_PANEL,
                                                String.valueOf(playerTrainerInstance.getPokemon(FIRST_POSITION).get()
                                                                .getLevel().getCurrentValue()),
                                                Color.WHITE,
                                                0.04, 0.79, 0.64));
                this.currentSceneGraphicElements.put(SceneFightGraphicEnum.ENEMY_POKEMON_LEVEL_TEXT.value(),
                                new TextElementImpl(FIRST_PANEL,
                ...
                this.currentSceneGraphicElements.put(SceneFightGraphicEnum.MY_POKEMON_ACTUAL_LIFE_TEXT.value(),
                                new TextElementImpl(FIRST_PANEL,
                                                ...
                                                Color.GREEN,
                                                0.04, 0.81, 0.64));
                this.currentSceneGraphicElements.put(SceneFightGraphicEnum.ENEMY_POKEMON_ACTUAL_LIFE_TEXT.value(),
                                new TextElementImpl(FIRST_PANEL,
                ...
                this.currentSceneGraphicElements.put(SceneFightGraphicEnum.MY_POKEMON_ACTUAL_EXP_TEXT.value(),
                                new TextElementImpl(FIRST_PANEL, "exp. " +
                                                ...
                                                0.04, 0.69, 0.67));
                // TEXT STATUS
                this.currentSceneGraphicElements.put(SceneFightGraphicEnum.ENEMY_POKEMON_STATUS_TEXT.value(),
                ...
                this.currentSceneGraphicElements.put(SceneFightGraphicEnum.MY_POKEMON_STATUS_TEXT.value(),
                                new TextElementImpl(FIRST_PANEL, "Status: " +
                                                (playerTrainerInstance.getPokemon(FIRST_POSITION).get()
                                                                .getStatusCondition().isPresent()
        ...
        private void initButtonElements() {
                this.currentSceneGraphicElements.put(SceneFightStatusValuesEnum.BALL_BUTTON.value(),
                                new ButtonElementImpl(FIRST_PANEL, new Color(38, 102, 102), Color.WHITE, 0, 0.77, 0.74,
                                                0.2, 0.1));
                this.currentSceneGraphicElements.put(SceneFightStatusValuesEnum.FIGHT_BUTTON.value(),
                                new ButtonElementImpl(FIRST_PANEL, new Color(38, 102, 102), Color.WHITE, 0, 0.55, 0.74,
                                                0.2, 0.1));
                this.currentSceneGraphicElements.put(SceneFightStatusValuesEnum.RUN_BUTTON.value(),
                                new ButtonElementImpl(FIRST_PANEL, new Color(38, 102, 102), Color.WHITE, 0, 0.77, 0.87,
                                                0.2, 0.1));
                this.currentSceneGraphicElements.put(SceneFightStatusValuesEnum.POKEMON_BUTTON.value(),
        ...
        private void initSpriteElements() {
                this.currentSceneGraphicElements.put(SceneFightGraphicEnum.MY_POKEMON_SPRITE.value(),

                                new SpriteElementImpl(FIRST_PANEL, playerTrainerInstance
                                                .getPokemon(FIRST_POSITION).get().getSpriteBack(), 0.03, 0.21, 0.55,
                                                0.55));
                this.currentSceneGraphicElements.put(SceneFightGraphicEnum.ENEMY_POKEMON_SPRITE.value(),
